...
class QuizThreeController extends Controller
{
    //
    public function tercera()
    {
        $parte_tres = file_get_contents('json/parte3.json');
        $preguntas_tres = json_decode($parte_tres);
        ...
        if ($prueba) { 
            ...
            return view('quiz.parte3', compact('preguntas_tres', 'arreglo'));
        } else {
            return view('quiz.parte3', compact('preguntas_tres'));
        }
    }
}
