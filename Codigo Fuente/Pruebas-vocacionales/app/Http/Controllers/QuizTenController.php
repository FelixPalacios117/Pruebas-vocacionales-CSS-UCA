...
class QuizTenController extends Controller
{
    //
    ...
    public function decima()
    {
        $parte_diez = file_get_contents('json/parte10.json');
        $preguntas_diez = json_decode($parte_diez);
        ...
        if ($prueba) { 
            ...
            return view('quiz.parte10', compact('preguntas_diez', 'arreglo'));
        } else {
            return view('quiz.parte10', compact('preguntas_diez'));
        }
    }
}
