...
class QuizSixController extends Controller
{
    //
    ...
    //
    public function sexta()
    {
        $parte_seis= file_get_contents('json/parte6.json');
        $preguntas_seis = json_decode($parte_seis);
        ...
        if ($prueba) {
            ...
            return view('quiz.parte6', compact('preguntas_seis', 'arreglo'));
        } else {
            return view('quiz.parte6', compact('preguntas_seis'));
        }
    }
}
