...
class QuizFiveController extends Controller
{
    //
    ...
    {
        $parte_cinco= file_get_contents('json/parte5.json');
        $preguntas_cinco = json_decode($parte_cinco);
        ...
        if ($prueba) { 
            ...
            return view('quiz.parte5', compact('preguntas_cinco', 'arreglo'));
        } else {
            return view('quiz.parte5', compact('preguntas_cinco'));
        }
