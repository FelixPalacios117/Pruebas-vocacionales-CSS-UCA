...
class QuizEightController extends Controller
{
    //
    ...
    {
        $parte_ocho = file_get_contents('json/parte8.json');
        $preguntas_ocho = json_decode($parte_ocho);
        ...
        if ($prueba) { 
            ...
            return view('quiz.parte8', compact('preguntas_ocho', 'arreglo'));
        } else {
            return view('quiz.parte8', compact('preguntas_ocho'));
        }
    }
}
