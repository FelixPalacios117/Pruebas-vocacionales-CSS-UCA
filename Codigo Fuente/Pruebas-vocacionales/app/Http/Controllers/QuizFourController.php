...
class QuizFourController extends Controller
{
    ...
    {
        $parte_cuatro = file_get_contents('json/parte4.json');
        $preguntas_cuatro = json_decode($parte_cuatro);
        ...
        if ($prueba) {
            ...
            return view('quiz.parte4', compact('preguntas_cuatro', 'arreglo'));
        } else {
            return view('quiz.parte4', compact('preguntas_cuatro'));
        }
    }
}
