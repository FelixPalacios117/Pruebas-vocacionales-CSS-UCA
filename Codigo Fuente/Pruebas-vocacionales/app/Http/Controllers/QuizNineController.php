...
class QuizNineController extends Controller
{

    public function novena()
    {
        $parte_nueve = file_get_contents('json/parte9.json');
        $preguntas_nueve = json_decode($parte_nueve);
        ...
        if ($prueba) {
            ...
            return view('quiz.parte9', compact('preguntas_nueve', 'arreglo'));
        } else {
            return view('quiz.parte9', compact('preguntas_nueve'));
        }
    }
